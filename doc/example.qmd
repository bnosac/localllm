...
- localllm.connect downloads the model if it does not exist
...
#| output: false
import localllm
from localllm import LocalChatAdapter
...
llm = localllm.connect(model_name, 
                       model_kwargs = dict(
                            verbose = False, 
                            n_ctx = 32768, n_gpu_layers = 0, n_threads = 1, flash_attn = True, swa_full = True, seed = 4321),
